        ...
        <div className="relative px-6 py-4 flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2
                className={cn(
                  "text-gray-800 font-semibold bg-clip-text text-transparent",
              ...
              <p className="text-xs text-gray-700/80 mt-1 font-medium">
                {description} •{" "}
            ...
            emptyMessage={
              <div className="col-span-full flex items-center justify-center min-h-[240px]">
                <div className="text-center max-w-md mx-auto px-4">
                  ...
                  <h3
                    className={cn(
                      "text-gray-800 font-semibold mb-2",
                  ...
                  <p className="text-xs text-gray-700/80 mb-4 leading-relaxed">
                    {emptyDescription}
                  </p>
                  <CreateResumeDialog
                    type={type}
