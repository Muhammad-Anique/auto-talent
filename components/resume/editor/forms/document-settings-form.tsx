...
function NumberInput({ value, onChange, min, max, step }: NumberInputProps) {
  ...
  return (
    <div className="flex items-center space-x-1">
      <span className="text-xs text-gray-700/60 w-8">{displayValue}</span>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            />
            <span className="text-xs text-gray-700/60 ml-1">pt</span>
          </div>
        </div>
        <Slider
                ...
                <div className="space-y-2 mt-4 pt-4 border-t border-slate-200/50">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <span className="text-xs text-gray-700/60 ml-1">%</span>
                    </div>
                  </div>
                  <Slider
                    value={[documentSettings?.footer_width ?? 95]}
                  ...
                  <div className="flex justify-between mt-1">
                    <span className="text-[10px] text-gray-700/40">Narrow</span>
                    <span className="text-[10px] text-gray-700/40">
                      Full Width
                    </span>
                  </div>
                </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <span className="text-xs text-gray-700/60 ml-1">x</span>
                  </div>
                </div>
                <Slider
                  value={[documentSettings?.document_line_height ?? 1.5]}
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 bg-slate-50/50 rounded-lg p-4 border border-slate-200/50">
              ...
              <div className="space-y-2">
                ...
                />
                <div className="flex justify-between mt-1">
                  <span className="text-[10px] text-gray-700/40">Compact</span>
                  <span className="text-[10px] text-gray-700/40">Spacious</span>
                </div>
              </div>
            </div>
          </div>
