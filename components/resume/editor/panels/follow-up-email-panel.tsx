...
export function FollowUpEmailPanel({
  ...
  const generateFollowUpEmail = async () => {
    ...
    try {
      ...
      // Prompt
      const prompt = `Write a professional Follow Up Email with a proper subject for the following job using my resume information:
      ${JSON.stringify(job)}
      ...
      if (error instanceof Error && (
        ...
        setErrorMessage({
          title: "Error",
          description: "Failed to generate Follow Up Email. Please try again."
        });
      }
