...
import {
  updateEmail,
  updatePassword,
} from "@/app/(autoTalent-app)/dashboard/settings/actions";
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-700">Current email: {user?.email}</p>
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              >
                <Loader2
                  className={`mr-2 h-4 w-4 animate-spin ${!isUpdatingEmail && "opacity-0"}`}
                />
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <div className="flex gap-4">
            ...
            >
              <Loader2
                className={`mr-2 h-4 w-4 animate-spin ${!isUpdatingPassword && "opacity-0"}`}
              />
