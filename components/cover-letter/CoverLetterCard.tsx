...
import { FileText, ArrowRight, Calendar, Eye } from "lucide-react";
...
const CoverLetterCard: FC<CoverLetterCardProps> = ({ title, context, id }) => {
  ...
  const preview = context.slice(0, 150) + (context.length > 150 ? "..." : "");
  ...
  return (
    <Card className={cn(
      ...
      <div className={cn(
        ...
        <Link href={`/dashboard/coverletter/${id}`}>
          <Button
            variant="ghost"
            className={cn(
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">View Full Letter</span>
            </div>
