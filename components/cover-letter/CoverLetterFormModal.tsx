      ...
      <Card className={cn(
        ...
        <div className="px-8 py-6 space-y-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Job Description */}
            <div className="space-y-2">
              <Label htmlFor="jobDescription" className="text-sm font-medium text-zinc-700">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between text-xs text-zinc-600">
                  <span>Formal</span>
                  <span className="text-[#5b6949] font-medium">Current: {tone}/10</span>
                  <span>Casual</span>
                </div>
            ...
            <div className={cn(
              ...
              tone <= 3 ? "bg-blue-50 border-blue-200" :
              tone <= 7 ? "bg-amber-50 border-amber-200" :
              "bg-green-50 border-green-200"
            )}>
              <div className="flex items-center gap-2 mb-2">
                <Sparkles className="w-4 h-4 text-[#5b6949]" />
                <span className="text-sm font-medium text-zinc-700">Tone Preview</span>
              </div>
              <p className="text-xs text-zinc-600">
                {tone <= 3 ? "Your email will have a formal, professional tone suitable for corporate environments." :
                 tone <= 7 ? "Your email will have a balanced tone that's professional yet approachable." :
