...
export function ProfileCard({
  ...
  const styles = {
    ...
    hover:
      "hover:bg-gradient-to-br hover:from-teal-100/80 hover:via-cyan-100/80 hover:to-teal-100/80",
  };
  ...
  return (
    <div className="relative group">
      ...
      >
        ...
        {/* Description */}
        <p className="text-gray-800 text-gray-700 px-8 leading-relaxed">
          {description}
        </p>

        {/* Updated text section */}
        <p className="mt-6 text-sm text-gray-700 px-8 leading-relaxed">
          A central place for all your work experiences, projects, skills, and
          accomplishments
        </p>
      </div>
    </div>
