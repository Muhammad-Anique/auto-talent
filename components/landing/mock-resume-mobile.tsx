...
export function MockResumeMobile() {
  return (
    <Card
      className="w-full max-w-[6in] aspect-[8.5/11] bg-white relative p-4 font-sans 
    ...
    >
      ...
      <div className="mb-4 text-center">
        <h2 className="text-gray-800 font-bold text-gray-900 mb-0.5">
          David Zhang
        </h2>
      ...
      {/* Technical Skills */}
      <div className="mb-3">
        <h3 className="text-[8px] font-bold text-gray-900 mb-1 uppercase tracking-wider border-b border-gray-200 pb-0.5">
          Technical Skills
        </h3>
        <div className="flex flex-wrap gap-0.5">
          <Badge
            variant="secondary"
            className="bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors text-[8px] py-0 px-1"
          >
      ...
      <div className="mb-3">
        ...
        <div className="space-y-2">
          <div>
            ...
            <p className="text-[8px] font-medium text-gray-700 mb-0.5">
              Clio, Vancouver, BC
            </p>
            <ul className="text-[8px] text-gray-600 list-disc list-outside ml-2.5 space-y-0.5">
              <li>
                Developed key features for legal platform using React and
                TypeScript
              </li>
              <li>
                Implemented AI document analysis reducing review time by 60%
              </li>
          ...
          <div>
            ...
            <ul className="text-[8px] text-gray-600 list-disc list-outside ml-2.5 space-y-0.5">
              <li>
                Built responsive dashboard components using React and Redux
              </li>
          ...
          <div>
            <div className="flex justify-between items-baseline">
              ...
              <p className="text-[8px] text-gray-600">
                github.com/davidzhang-dev/meeting-ai
              </p>
            </div>
            <ul className="text-[8px] text-gray-600 list-disc list-outside ml-2.5 space-y-0.5">
              <li>
                Built meeting summarization tool using OpenAI API and Next.js
              </li>
              <li>
                Implemented real-time transcription and key points extraction
              </li>
            </ul>
          </div>
          <div>
            <div className="flex justify-between items-baseline">
              ...
              <p className="text-[8px] text-gray-600">
                github.com/davidzhang-dev/van-housing
              </p>
            </div>
            <ul className="text-[8px] text-gray-600 list-disc list-outside ml-2.5 space-y-0.5">
              <li>
                Created web scraper and analysis tool for real estate listings
              </li>
