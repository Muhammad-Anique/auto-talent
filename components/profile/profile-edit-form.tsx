...
export function ProfileEditForm({
  ...
  const handleResumeUpload = async (content: string) => {
    try {
      ...
      const selectedModel =
        localStorage.getItem(MODEL_STORAGE_KEY) || "claude-3-sonnet-20240229";
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                    ...
                    >
                      ...
                      <div className="relative flex items-center gap-4">
                        ...
                        <div className="text-left">
                          ...
                          <div className="text-sm text-[#0077b5]/70">
                  ...
                  <DialogContent className="sm:max-w-[600px] bg-white/95 backdrop-blur-xl border-white/40 shadow-2xl">
                      ...
                      <DialogDescription asChild>
                        <div className="space-y-2 text-base text-muted-foreground/80">
                          ...
                          <span className="block text-sm">
                            Enter your LinkedIn profile URL below. Our AI will
                            extract your public profile data and help you
                            populate your resume. We do not store your LinkedIn
                            credentials or any sensitive information.
                          </span>
                        </div>
                      </DialogDescription>
                    </DialogHeader>

                    {/* --- URL Input + “Fetch from LinkedIn” button --- */}
                    <div className="flex items-center gap-2">
                      <Input
                        type="url"
                        ...
                        className="flex-1 bg-white/50 border-white/40 focus:border-violet-500/40 focus:ring-violet-500/20 transition-all duration-300"
                      />
                      <Button
                    ...
                    {/* --- Textarea for resumeContent --- */}
                    <div className="mt-4">
                      <Textarea
                        value={resumeContent}
                        onChange={(e) => setResumeContent(e.target.value)}
                        placeholder="Paste your resume content here..."
                        className="w-full min-h-[120px] bg-white/50 border-white/40 focus:border-violet-500/40 focus:ring-violet-500/20 transition-all duration-300"
                      />
                    </div>
