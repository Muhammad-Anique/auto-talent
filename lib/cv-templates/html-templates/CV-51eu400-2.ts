...
/**
 * Dark Teal Sidebar CV Template
 * Based on Screenshot 2 design (Marlon Manner style)
 * Features: Dark navy/teal sidebar with circular photo, contact, skills, languages, reference.
 * Right side has profile, work experience, education.
 */

export function generateCV51eu4002Template(resume: Resume): string {
...
<head>
  ...
  <style>
    * {
    ...
    /* Landscape banner at top */
    .sidebar-banner {
      width: 100%;
      height: 60px;
      background: linear-gradient(135deg, #2e7d32 0%, #4caf50 40%, #81c784 60%, #a5d6a7 80%, #e8f5e9 100%);
      position: relative;
    }
    ...
    .sidebar-banner::after {
      ...
      right: 0;
      height: 30px;
      background: linear-gradient(to top, #1b2a3d, transparent);
    }
      ...
      <div class="sidebar-body">
        ...
        <div class="sidebar-section">
          ...
          <ul class="languages-list">
            <li><span>English</span><span class="level">Native</span></li>
            ${resume.current_language && resume.current_language !== 'en' ? `<li><span>${resume.current_language}</span><span class="level">Professional</span></li>` : ''}
          </ul>
        </div>
        ...
        <div class="sidebar-section">
          ...
          <div class="reference-item">
            ...
            <div class="ref-title">Professional references provided during interview process.</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="main-content">
      ...
      <div class="section">
        ...
        <div class="profile-text">
          ...
          Proven expertise in ${resume.skills?.[0]?.items?.[0] || 'strategic planning'},
          ${resume.skills?.[0]?.items?.[1] || 'team leadership'}, and
          ${resume.skills?.[0]?.items?.[2] || 'operational excellence'}.
          Dedicated to driving organizational growth through innovative strategies and results-oriented leadership.
        </div>
      </div>
