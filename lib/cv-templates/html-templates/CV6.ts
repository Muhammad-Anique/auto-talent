...
/**
 * CV6: Dark Slate Sidebar Resume
 * Two-column layout: dark slate sidebar (35%) with circular profile photo, contact, education, skills, languages.
 * Right side: white content with bold name header, profile, experience, reference.
 * Fonts: Montserrat (headings), Open Sans (body).
 * Accent: Deep blue teal #1a7a8a, Sidebar #2d3e50, Text dark #2c3e50.
 */

export function generateCV6Template(resume: Resume): string {
...
<body>
  <div class="resume-container">
    ...
    <div class="main-content">
      <div class="header">
        <h1><span class="first-name">${resume.first_name.toUpperCase()}</span> <span class="last-name">${resume.last_name.toUpperCase()}</span></h1>
