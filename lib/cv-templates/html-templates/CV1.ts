...
/**
 * CV1: Dark Blue Sidebar Resume
 * Two-column layout: dark navy sidebar (35%) with circular profile photo, contact, education, skills, languages.
 * Right side: white content with name/role header, profile, experience, projects, reference.
 * Fonts: Playfair Display (headings), Source Sans Pro (body).
 * Accent: Teal #3d7c8c, Sidebar #2b3a4e, Text dark #2c3e50.
 */
